...
\noindent Calculations are in appendix ??????. We see that even though it costs to power up the node from sleep mode, it would still extend the battery life span putting it to sleep as often as possible. %TODO create appendix and ref to it!
