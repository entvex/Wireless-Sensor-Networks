...
# 4 "/home/tinyos/workspace/runner/src/src/Runner.h"
enum __nesc_unnamed4294 {
  ...
  SET_POWER = 31, 
  ARQ_RETRYCOUNT = 10, 
  SIGNAL_STRENGTH_LOW = 1, 
  SIGNAL_STRENGTH_MID = 16, 
  SIGNAL_STRENGTH_HIGH = 31
};
...
typedef TMilli RunnerP__Timer0__precision_tag;
typedef TMilli RunnerP__Timer2__precision_tag;
...
static void RunnerP__Timer0__fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void RunnerP__AMControl__startDone(error_t error);
#line 117
static void RunnerP__AMControl__stopDone(error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void RunnerP__Boot__booted(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void RunnerP__AMSend__sendDone(
#line 92
message_t * msg, 
...
uint8_t len);
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void RunnerP__Timer2__fired(void );
# 34 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430Compare.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void RunnerP__Timer0__startOneShot(uint32_t dt);
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t RunnerP__AMControl__start(void );
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
static 
#line 112
void * 
...
uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t RunnerP__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void RunnerP__CC2420Packet__setPower(message_t *p_msg, uint8_t power);
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void RunnerP__Leds__led0Off(void );
...
static void RunnerP__Leds__led1On(void );




static void RunnerP__Leds__led1Off(void );
#line 83
static void RunnerP__Leds__led2Off(void );
#line 45
static void RunnerP__Leds__led0On(void );
#line 78
static void RunnerP__Leds__led2On(void );
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void RunnerP__Timer2__startPeriodic(uint32_t dt);
#line 67
static void RunnerP__Timer2__stop(void );
# 30 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__sendAcknowledge(requestMessage *arg_0x40b9f8e8);
static inline void RunnerP__sendData(uint16_t nodeid);
static inline void RunnerP__setLedRed(void );
static inline void RunnerP__setLedGreen(void );
static inline void RunnerP__setLedBlue(void );
static inline void RunnerP__printAck(ackMessage *ackmsg);

static inline void RunnerP__printGotReq(requestMessage *reqmsg);

bool RunnerP__busy = FALSE;
message_t RunnerP__pkt;


uint8_t RunnerP__resendCounter = 0;


nx_uint16_t RunnerP__nodeidToSendTo;
nx_uint16_t RunnerP__counterToSendTo;
nx_uint16_t RunnerP__seqToSendTo;
nx_uint16_t RunnerP__relaynodeIdToSendTo;
...
static inline void RunnerP__Timer0__fired(void );
...
static inline void RunnerP__printSendingData(requestMessage *responsemsg);




static inline void RunnerP__Timer2__fired(void );




static inline void RunnerP__Boot__booted(void );




static inline void RunnerP__AMControl__stopDone(error_t error);



static inline void RunnerP__AMControl__startDone(error_t error);




static inline void RunnerP__AMSend__sendDone(message_t *msg, error_t error);
...
static inline void RunnerP__sendAcknowledge(requestMessage *reqmsg);
#line 145
static inline void RunnerP__sendData(uint16_t nodeid);
#line 179
static inline message_t *RunnerP__Receive__receive(message_t *msg, void *payload, uint8_t len);
# 30 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430Compare.nc"
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static error_t /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40633ce8){
#line 28
  switch (arg_0x40633ce8) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40633ce8);
#line 28
      break;
#line 28
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40ab1a58){
#line 55
  switch (arg_0x40ab1a58) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40ab1a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40ed7388){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x40ed7388) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40ed7388);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x4122f688, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x4122f688, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40ed7388){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40ed7388);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40ed7dd8){
#line 39
  union __nesc_unnamed4279 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40ed7dd8);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40ab1a58){
#line 49
  switch (arg_0x40ab1a58) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40ab1a58);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40ab3690){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40ab3690);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40ed7388){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40ed7388);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40ab3690){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40ab3690);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40ed7388){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40ed7388);
#line 78
      break;
#line 78
    }
...
#line 54
# 112 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__AMSend__sendDone(message_t *msg, error_t error)
#line 112
{
  if (&RunnerP__pkt == msg) {
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  RunnerP__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x40b2ae48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b2ae48) {
#line 89
    case 0U:
#line 89
      /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x40b2ae48, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40b27908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40b27908, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x4122f010, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x4122f010, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x4122f688, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x4122f688, msg);
#line 95
}
#line 95
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x412315b8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x412315b8, msg, payload, len);
#line 67
...
inline static void RunnerP__Timer2__stop(void ){
#line 67
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void RunnerP__Timer2__startPeriodic(uint32_t dt){
#line 53
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void RunnerP__Timer0__startOneShot(uint32_t dt){
#line 62
...
inline static void RunnerP__Leds__led1On(void ){
#line 61
  LedsP__Leds__led1On();
#line 61
}
#line 61
# 56 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__setLedGreen(void )
#line 56
{
  RunnerP__Leds__led1On();
  RunnerP__Timer0__startOneShot(100);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t RunnerP__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
# 56 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static void RunnerP__CC2420Packet__setPower(message_t *p_msg, uint8_t power){
#line 56
  CC2420PacketP__CC2420Packet__setPower(p_msg, power);
#line 56
}
#line 56
# 72 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__printAck(ackMessage *ackmsg)
#line 72
{
  printf("Sending acknowledge with size: %d should be %d nodeid: %d receiveid: %d seq: %d counter: %d\n", sizeof  (*ackmsg), sizeof(ackMessage ), __nesc_ntoh_uint32(ackmsg->nodeid.data), __nesc_ntoh_uint32(ackmsg->receiveid.data), __nesc_ntoh_uint32(ackmsg->seq.data), __nesc_ntoh_uint32(ackmsg->counter.data));
  printfflush();
}
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * RunnerP__Packet__getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 115
# 119 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__sendAcknowledge(requestMessage *reqmsg)
#line 119
{
  if (!RunnerP__busy) {
      ackMessage *ackmsg = (ackMessage *)RunnerP__Packet__getPayload(&RunnerP__pkt, sizeof(ackMessage ));
...
#line 122
      ...
      if (PRINT) 
        {
          RunnerP__printAck(ackmsg);
        }

      RunnerP__CC2420Packet__setPower(&RunnerP__pkt, SIGNAL_STRENGTH_LOW);

      if (RunnerP__AMSend__send(AM_BROADCAST_ADDR, &RunnerP__pkt, sizeof(ackMessage )) == SUCCESS) {
          RunnerP__busy = TRUE;
          if (PRINT) 
            {
              RunnerP__setLedGreen();
            }
        }
    }
  return;
...
#line 83
{
  printf("Got request with size: %d should be %d nodeid: %d relaynodeid: %d seq: %d counter: %d data: %d\n", sizeof  (*reqmsg), sizeof(requestMessage ), __nesc_ntoh_uint32(reqmsg->nodeid.data), __nesc_ntoh_uint32(reqmsg->relayNodeid.data), __nesc_ntoh_uint32(reqmsg->seq.data), __nesc_ntoh_uint32(reqmsg->counter.data), __nesc_ntoh_int32(reqmsg->data.data));
  printfflush();
}
...
inline static void RunnerP__Leds__led2On(void ){
#line 78
  LedsP__Leds__led2On();
#line 78
}
#line 78
# 61 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__setLedBlue(void )
#line 61
{
  RunnerP__Leds__led2On();
  RunnerP__Timer0__startOneShot(100);
}
...
#line 179
{
  ...
  if (len == sizeof(requestMessage )) {
      ...
      if (__nesc_ntoh_uint32(requestpkt->nodeid.data) == __nesc_ntoh_uint32(requestpkt->relayNodeid.data) && __nesc_ntoh_int32(requestpkt->data.data) == 0) {

          if (PRINT) 
            {
              RunnerP__setLedBlue();
              RunnerP__printGotReq(requestpkt);
            }

          RunnerP__sendAcknowledge(requestpkt);


          __nesc_hton_uint16(RunnerP__nodeidToSendTo.data, __nesc_ntoh_uint32(requestpkt->nodeid.data));
          __nesc_hton_uint16(RunnerP__counterToSendTo.data, __nesc_ntoh_uint32(requestpkt->counter.data));
          __nesc_hton_uint16(RunnerP__seqToSendTo.data, __nesc_ntoh_uint32(requestpkt->seq.data));
          __nesc_hton_uint16(RunnerP__relaynodeIdToSendTo.data, __nesc_ntoh_uint32(requestpkt->relayNodeid.data));

          RunnerP__Timer2__startPeriodic(TIMER_PERIOD_MILLI);
        }
    }
  else {
#line 204
    if (len == sizeof(ackMessage )) {
        ...
        if (__nesc_ntoh_uint32(ackpkt->receiveid.data) == TOS_NODE_ID) {
            RunnerP__Timer2__stop();
            RunnerP__resendCounter = 0;
          }
      }
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x41232e58, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67
...
#line 67
    case 4:
#line 67
      __nesc_result = RunnerP__Receive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x41232e58, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40b27908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40b27908, addr, msg, len);
#line 69
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
# 151 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40edb648){
#line 92
  switch (arg_0x40edb648) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40edb648);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40ab4bd0){
#line 92
  switch (arg_0x40ab4bd0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40ab4bd0);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40ed8b78, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40ed8b78) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40ed8b78, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40e9c010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40e9c010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40e9c010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x4122f688, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x4122f688, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40e9c010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40e9c010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40e9c010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40e9d558){
#line 92
  switch (arg_0x40e9d558) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40e9d558);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41232498, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41232498, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
# 103 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__AMControl__stopDone(error_t error)
#line 103
{
}
...
#line 117
  RunnerP__AMControl__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t RunnerP__AMControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 83
# 107 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__AMControl__startDone(error_t error)
#line 107
{
  if (error != SUCCESS) {
    RunnerP__AMControl__start();
    }
}
...
#line 92
  RunnerP__AMControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
inline static void RunnerP__Leds__led2Off(void ){
#line 83
...
inline static void RunnerP__Leds__led1Off(void ){
#line 66
...
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void RunnerP__Leds__led0Off(void ){
#line 50
  LedsP__Leds__led0Off();
#line 50
}
#line 50
# 66 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__Timer0__fired(void )
#line 66
{
  RunnerP__Leds__led0Off();
  RunnerP__Leds__led1Off();
  RunnerP__Leds__led2Off();
}
...
inline static void RunnerP__Leds__led0On(void ){
#line 45
  LedsP__Leds__led0On();
#line 45
}
#line 45
# 51 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__setLedRed(void )
#line 51
{
  RunnerP__Leds__led0On();
  RunnerP__Timer0__startOneShot(100);
}
...
#line 88
{
  printf("Sending data with size: %d should be %d nodeid: %d relaynodeid: %d seq: %d counter: %d data: %d\n", sizeof  (*responsemsg), sizeof(requestMessage ), __nesc_ntoh_uint32(responsemsg->nodeid.data), __nesc_ntoh_uint32(responsemsg->relayNodeid.data), __nesc_ntoh_uint32(responsemsg->seq.data), __nesc_ntoh_uint32(responsemsg->counter.data), __nesc_ntoh_int32(responsemsg->data.data));
  printfflush();
}
...
#line 145
{
  ...
  if (!RunnerP__busy) {
      requestMessage *responsepkt = (requestMessage *)RunnerP__Packet__getPayload(&RunnerP__pkt, sizeof(requestMessage ));

      __nesc_hton_uint32(responsepkt->nodeid.data, TOS_NODE_ID);
      __nesc_hton_uint32(responsepkt->seq.data, __nesc_ntoh_uint16(RunnerP__seqToSendTo.data));
      __nesc_hton_uint32(responsepkt->counter.data, __nesc_ntoh_uint16(RunnerP__counterToSendTo.data));
      __nesc_hton_uint32(responsepkt->relayNodeid.data, __nesc_ntoh_uint16(RunnerP__relaynodeIdToSendTo.data));
      __nesc_hton_int32(responsepkt->data.data, 55);

      if (PRINT) 
        {
          RunnerP__printSendingData(responsepkt);
        }

      if (RunnerP__AMSend__send(AM_BROADCAST_ADDR, &RunnerP__pkt, sizeof(requestMessage )) == SUCCESS) {
          RunnerP__busy = TRUE;
          RunnerP__resendCounter++;
  ...
  if (RunnerP__resendCounter >= TRIES_TO_RESEND) {
      RunnerP__Timer2__stop();
      RunnerP__resendCounter = 0;
    }
}
...
#line 93
{
  ...
  RunnerP__sendData(__nesc_ntoh_uint16(RunnerP__nodeidToSendTo.data));
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40c4c030){
#line 72
  switch (arg_0x40c4c030) {
#line 72
    case 0U:
#line 72
      RunnerP__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      RunnerP__Timer2__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40c4c030);
#line 72
      break;
#line 72
    }
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40b2ae48, message_t * msg, error_t error){
#line 89
  switch (arg_0x40b2ae48) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40b2ae48, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40ab4bd0){
#line 92
  switch (arg_0x40ab4bd0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40ab4bd0);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40ab1a58){
#line 49
  switch (arg_0x40ab1a58) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40ab1a58);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x408911b8){
#line 39
  union __nesc_unnamed4283 *__nesc_result;
#line 39

#line 39
  switch (arg_0x408911b8) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x408911b8);
#line 39
      break;
#line 39
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40ab1a58){
#line 55
  switch (arg_0x40ab1a58) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40ab1a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x40892718){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x40892718) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x40892718);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x40892718){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x40892718);
#line 118
      break;
#line 118
    }
...
# 98 "/home/tinyos/workspace/runner/src/src/RunnerP.nc"
static inline void RunnerP__Boot__booted(void )
#line 98
{
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40ab3690){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40ab3690);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.1.1/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x40892718){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x40892718);
#line 87
      break;
#line 87
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x408942c8, uint8_t byte){
#line 79
  switch (arg_0x408942c8) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x408942c8, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x408942c8, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x408942c8) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x408942c8, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40a93ce8, uint8_t data){
#line 54
  switch (arg_0x40a93ce8) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40a93ce8, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x408942c8, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x408942c8) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x408942c8, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40a93ce8){
#line 49
  switch (arg_0x40a93ce8) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40a93ce8);
#line 49
      break;
#line 49
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40a93ce8, uint8_t data){
#line 54
  switch (arg_0x40a93ce8) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40a93ce8, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40a90cf8){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40a90cf8);
#line 39
}
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40a93ce8){
#line 49
  switch (arg_0x40a93ce8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40a93ce8);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40633ce8){
#line 28
  switch (arg_0x40633ce8) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40633ce8);
#line 28
      break;
#line 28
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x4059d4a0){
#line 64
  switch (arg_0x4059d4a0) {
#line 64
    case SerialP__RunTx:
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x4059d4a0);
#line 64
      break;
#line 64
    }
...
#line 47
{
  /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 4);
  return /*RunnerC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
