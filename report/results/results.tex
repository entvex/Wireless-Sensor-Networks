...
\noindent \textbf{\textit{n} packets relayed to node 1 ($p_2$):} Number of packets relayed to relay station 1 (north).

\noindent \textbf{\textit{n} packets relayed to node 2 ($p_3$):} Number of packets relayed to relay station 2 (south).
...
\noindent asdasdasdasd asd sa

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{results/NoDataReceived}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{results/NoPacketsRelayed}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{results/NoPacketsNotACKInTime}
